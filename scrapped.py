...
def force_login_and_save_auth(playwright):
    print("🔐 Forcing re-authentication. Launching browser...")
    browser = playwright.chromium.launch(headless=False)
    context = browser.new_context()
    page = context.new_page()
    page.goto(f"{BASE_URL}/login")

    print("🌐 Please log in using Google manually.")
    print("👉 After login completes, press ▶️ (Resume) on the Playwright bar.")

    page.pause()  # Wait for manual Google login
